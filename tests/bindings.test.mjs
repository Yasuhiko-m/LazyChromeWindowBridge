...
import { BindingManager } from '../src/Extension/bindings.js';
...
function fixture() {
  ...
  function bootstrap(windowId, tabId) {
    ...
    const url = `http://127.0.0.1:45678/lazy-chrome-extension/bootstrap#v=1&bridge=${bridgeId}&session=${appSessionId}&token=${'A'.repeat(64)}`;
