// Source-owned R003 acceptance, using the established R002 real browser/production caller fixture.
...
export async function testGeometry({ caller, cdp, until, delay, evidence, pageA, pageB }) {
  ...
  console.log('PASS: R003 real native geometry persistence, independent profiles, PARK/RESTORE, concurrent isolation, parked navigation, relaunch and parked close.');
}
