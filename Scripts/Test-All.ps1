...
try {
    ...
    try {
        ...
        & node --test '.\tests\LazyChromeWindowBridge.Extension.Tests\bindings.test.mjs' '.\tests\LazyChromeWindowBridge.Extension.Tests\monitor.test.mjs' 2>&1 | Tee-Object -FilePath $scriptLog -Append
